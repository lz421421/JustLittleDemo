...
public class GifView extends ImageView implements GifAction {
    ...
    public GifView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.Gif);
        resId = a.getResourceId(R.styleable.Gif_gif, 0);
        if (resId != 0) {
            setGifImage(resId);
        }
        a.recycle();
    ...
    public int getGifDecoderHdight() {
        if (gifDecoder == null) {
            return 1;
        } else {
