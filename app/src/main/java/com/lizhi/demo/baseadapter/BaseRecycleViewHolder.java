...
public class BaseRecycleViewHolder extends RecyclerView.ViewHolder {
    ...
    public ImageView disPlayImage(@IdRes int id, String path) {
        ImageView circleImageView = getView(id);
//        AppContext.getInstance().disPlayImage(mConvertView.getContext(), path, circleImageView);
